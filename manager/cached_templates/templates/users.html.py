...
_magic_number = 10
_modified_time = 1455161177.1751997
_enable_loop = True
...
def render_center_content(context,**pageargs):
    ...
    try:
        ...
        for user in users:
            ...
            __M_writer('">Edit</a> |\r\n          <a data-pid= ')
            __M_writer(str( user.id ))
            __M_writer(' id="deletelink')
            __M_writer(str( user.id ))
            __M_writer('" data-toggle="modal" class="delete_button">Delete</a>\r\n        </td>\r\n      </tr>\r\n')
        __M_writer('  </table>\r\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
"""
__M_BEGIN_METADATA
{"uri": "users.html", "line_map": {"64": 24, "65": 24, "66": 25, "67": 25, "68": 26, "69": 26, "70": 27, "71": 27, "72": 32, "73": 32, "74": 33, "75": 33, "76": 33, "77": 33, "78": 37, "84": 3, "90": 3, "28": 0, "96": 90, "38": 1, "43": 5, "48": 38, "54": 7, "61": 7, "62": 22, "63": 23}, "source_encoding": "utf-8", "filename": "C:/Users/jpwil_000/Documents/School/2016 Winter Classes/IS 413/Colonial_Heritage_Foundation/manager/templates/users.html"}
__M_END_METADATA
"""
